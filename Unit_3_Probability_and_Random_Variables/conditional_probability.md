...
> GitHub-ready reading material with explanations, formulas, figures, examples, and Python implementations.
...
genui{"conditional_event_probability_learning_block_staging":{"type_id":"CONDITIONAL_PROBABILITY_DEFINITION"}}
...
1. `01_conditional_probability_restricted_space.png`
2. `02_venn_intersection_conditional.png`
3. `03_probability_tree_without_replacement.png`
4. `04_bayes_theorem_flow.png`
5. `05_independence.png`

Keep the `figures/` directory beside this Markdown file so GitHub renders the images correctly.
